...
<div class="row">
    ...
    <div class="col-md-6 position-relative" id="map-canvas" style="min-height: 500px; background-color: #f9f9f9; border: 1px solid #ccc;">
...
function addNode(type) {
    ...
    nodes.push({ id: nodeId, type: type, x: 50, y: 50 });
    nodeId++;
}
