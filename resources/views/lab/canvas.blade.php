...
<div id="sidebar" class="position-fixed sidebar-hidden">
    <div class="inner p-3">
        ...
        <div class="d-none gap-2 mb-2">
            <div onclick="selectCable('0.2', 'dropcore', this)" class="cable-option p-2 bg-light text-dark rounded text-center flex-fill cursor-pointer">
                <div style="width: 30px; height: 5px; background-color: black; margin: auto;"></div>
                <small>Dropcore</small>
            </div>
            <div onclick="selectCable('0.3', 'patchcord', this)" class="cable-option p-2 bg-warning text-dark rounded text-center flex-fill cursor-pointer">
...
<script>
    ...
    function addNodeFromDB(node) {
        ...
        el.innerHTML = `<strong>${node.type}</strong><div class="output-power" style="font-size: 12px; color: green;">${node.power.toFixed(2)} dB</div>`;
